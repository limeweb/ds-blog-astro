...
category: tutorials
tags: [design, science, web-development]
---
...
import image1 from "@assets/posts/meteorite-map-2-featured.jpg";
import image2 from "@assets/posts/meteorite-map-3.jpg";
import image3 from "@assets/posts/meteorite-map-earth.jpg";
import image4 from "@assets/posts/meteorite-map-1.jpg";
...
<Figure
    caption="Map of the United States showing meteorite falls."
    alt="Map of the United States showing meteorite falls."
    src={image1}
/>

View the map at [https://z4q4to.csb.app](https://z4q4to.csb.app) 🗺️
...
<Figure
    src={image2}
    alt="Dark theme map closeup of China, showing meteorite falls as orange circles, with larger mass meteorites as larger circles."
    caption="Are they meteorites or planet-sized asteroids...?"
/>
...
<Figure
    src={image3}
    alt="Dark theme map of entire earth, showing orange heatmap of meteorite falls by mass."
...
<Figure
    src={image4}
    alt="Map closeup of France and Switzerland, showing the Ensisheim fall of 1492."
    caption="From 1492!"
/>
