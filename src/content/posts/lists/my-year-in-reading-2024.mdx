...
import image1 from "@assets/posts/reading-philosopher.jpg";

<Figure
    src={image1}
    alt="Maria Catharina Prestel, 'Philosopher' (1783)."
    caption="Maria Catharina Prestel, “Philosopher” (1783), via Public Domain Image Archive."
/>
...
My favorites from this year, in no particular order:

<FeaturedBook id="recx7LZurVPABhi99" loading="eager" />
...
<FeaturedBook id="reckGioaKyeEamvbn" />
...
<FeaturedBook id="recfxtYWvJxRmhxua" />
...
<FeaturedBook id="recbNkkWVkHPjKXMl" />
...
<FeaturedBookList
    ids={["recqvY5trkMVAxk8C", "recx7LZurVPABhi99", "recMLF7Isc7x0MF9B"]}
/>
