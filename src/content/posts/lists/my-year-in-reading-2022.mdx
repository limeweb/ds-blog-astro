...
date: 2022-12-28
summary: Gesamtkunstwerke and politics as worldmaking.
category: lists
...
import image1 from "@assets/posts/reading-poet.jpg";

<Figure
    src={image1}
    alt="Domenico di Michelino's “La commedia illumina Firenze” on the wall of Florence Cathedral."
    caption="Domenico di Michelino's “La commedia illumina Firenze” on the wall of Florence Cathedral, via Wikimedia Commons."
/>
...
<FeaturedBook id="rec2kPSKqLhQvIuX7" loading="eager" />
...
<FeaturedBook id="recsDjs1zmRifCW9c" />
...
<FeaturedBook id="recyEioDb2o7g000h" HeadingLevel="p" />
...
<FeaturedBook id="recsBACDunKvwKbIu" />
...
<FeaturedBook id="recmpq6x25WVaiYm0" />
...
<FeaturedBookList ids={["recWD9qNrgwEawbZJ", "recikplkRLx0IEHoH"]} />
