...
date: 2023-05-21
summary: Thinking through the contradictions and cognitive terrain of postmodernism with Fredric Jameson.
category: essays
tags: [criticism, philosophy, theory]
---

import FeaturedBook from "@components/books/FeaturedBook.astro";
import Figure from "@components/posts/Figure.astro";
import image1 from "@assets/posts/paris-haussmann-plan.jpg";
import image2 from "@assets/posts/paris-le-corbusier.jpg";
import image3 from "@assets/posts/paris-disneyland.jpg";
...
<FeaturedBook id="recJSxTLJxRnVeXpr" HeadingLevel="h2" loading="eager" />
...
_The three stages of capitalist space: Or, a journey toward reification._

## Secularization (Grid)

<Figure
    src={image1}
    alt="1867 Ledot Pocket Map of Paris, France"
    caption="1867 Ledot Pocket Map of Paris, France"
/>
...
<Figure
    src={image2}
    alt="Plan Voisin in Paris, Le Corbusier"
    caption="Plan Voisin in Paris, Le Corbusier"
/>
...
<Figure
    src={image3}
    alt="Disneyland Hotel, Paris"
    caption="Disneyland Hotel, Paris"
/>
