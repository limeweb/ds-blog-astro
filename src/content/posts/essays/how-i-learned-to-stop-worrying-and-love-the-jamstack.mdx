...
<CodeBlock title="Project Directory">
...
<CodeBlock title="src/posts/essays/post.md">
...
<CodeBlock title="src/_includes/layouts/posts-index.njk">
...
<CodeBlock title="src/_includes/layouts/post-view.njk">
