...
date: 2024-01-20
summary: A new redesign of this site using Deno Lume, plus some fun server(less) interactions.
category: notes
...
<ContextBox type="context">
    This post references a previous design/version of this website.
</ContextBox>
...
![A post by me on Mastodon from September 2023, saying 'it me, I'm redesigning my site instead of writing the next blog post.'](../../../assets/posts/mastodon-site-post.jpg)
...
![Section of my new site showing book covers from my latest reading activity.](../../../assets/posts/ds-site-books.jpg)

I have incorporated elements of my [Airtable reading tracker](/posts/tutorials/airtable-reading-tracker-frontend) into the site—on the home page, I'm fetching some of my latest reading activity records to show a glance at my bookshelf. These entries pull data from Airtable, and, as a bonus, link to the associated books in the [counterpart website](https://long-wasp-15.deno.dev/), which I'm continuing to build out.
