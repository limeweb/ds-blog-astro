...
date: 2022-12-03
summary: How I used Airtable as a content management system for a small portfolio website.
category: tutorials
archived: true
...
import image1 from "@assets/posts/a-blake-table.png";
import image2 from "@assets/posts/a-blake-credits.png";
import image3 from "@assets/posts/a-blake-interface.png";

<ContextBox type="archive">
    This post about web development is more than 2 years old and shows processes
...
<Figure
    src={image1}
    alt="Screenshot of Airtable table on gradient background, showing various records under the title 'Credits'."
    caption="Records in the Credits table."
/>
...
<CodeBlock title="src/utils/airtable.js">
...
<CodeBlock title="Sample JSON response">
...
<CodeBlock title="src/pages/credits.astro">
...
const tableId = 'Credits'; // Can be the name or unique ID of the Airtable table
...
<Figure
    src={image2}
    alt="Screenshot of web page section on gradient background; heading reads 'Credits' followed by images laid out in a slider-carousel format."
    caption="Credits entries styled on the front-end."
/>
...
<CodeBlock title="src/components/credit.astro">
...
<Figure
    src={image3}
    alt="Screenshot of Airtable interface view on gradient background; sections shown include 'Credits' and 'Press Items'."
    caption="Airtable interface structured by “content collections” and displayed as visual cards."
/>
...
const webhookUrl = `https://api.netlify.com/build_hooks/${UNIQUE_NETLIFY_ID}?trigger_title=Airtable+Publish`;
...
const table = base.getTable("Publish");
